...
class ShowUserActivityCommandTest {
    ...
    public void before() {
        ...
        this.command = new ShowUserActivityCommand(repository);
        User user = repository.createUser(VALID_NAME);
    }

    @Test
    public void execute_Should_ShowUserActivity_When_ArgumentsAreValid() {
